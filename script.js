...
console.log(`My name is ${myName}, I am ${age} years old and I was born in ${birthmonth}.`);
/*
 * Prompt 3:
 *
...
let movies = ['Cat The Movie', 'Dog The Movie', 'Cat Isnt a Dog 1', 'Dogs are not Cats 2', 'Pet The Happening The Movie']
console.log(movies[1]);
movies.unshift('Dogcat The Movie')
movies.push('CatsVsDogs The Movie')
movies.splice(1, 0, 'CandyCat The Movie')
console.log(movies);
